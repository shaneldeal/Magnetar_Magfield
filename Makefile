...
PROBLEM_FILE = parker_eos_qw_tempscalar.cpp
COORDINATES_FILE = spherical_polar.cpp
EOS_FILE = general/qw_eos.cpp
GENERAL_EOS_FILE = general_mhd.cpp
...
CXX := mpicxx
CPPFLAGS :=  -I/apps/spack/0.21/pitzer/linux-rhel9-skylake/hdf5/intel/2021.10.0/mvapich/3.0/1.14.3-yfslvdi/include
CXXFLAGS := -O3 -std=c++11
LDFLAGS :=  -L/apps/spack/0.21/pitzer/linux-rhel9-skylake/hdf5/intel/2021.10.0/mvapich/3.0/1.14.3-yfslvdi/lib
LDLIBS :=  -lhdf5
GCOV_CMD := gcov
