...
// problem generator
#define PROBLEM_GENERATOR "parker_eos_qw_tempscalar"
...
#define COMPILED_WITH_OPTIONS " -I/apps/spack/0.21/pitzer/linux-rhel9-skylake/hdf5/intel/2021.10.0/mvapich/3.0/1.14.3-yfslvdi/include -O3 -std=c++11  -L/apps/spack/0.21/pitzer/linux-rhel9-skylake/hdf5/intel/2021.10.0/mvapich/3.0/1.14.3-yfslvdi/lib  -lhdf5" // NOLINT
